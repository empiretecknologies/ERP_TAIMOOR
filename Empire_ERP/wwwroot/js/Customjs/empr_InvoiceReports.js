var empr_InvoiceReports = {
    ...
    InitReportGrid(dataSrc, reportId) {
        ...
        ///add report pos salesman item wise 
            ...
            col = [
                { dataField: 'actName', caption: 'Act Name', width: 250, groupIndex: 0 },
                { dataField: 'category', caption: 'Category', width: 250, groupIndex: 1},
                { dataField: 'partyName', caption: 'Party Name', width: 250 },
            ];
            debugger;

            //if (dataSrc && dataSrc.length > 0) {
            //    let firstRow = dataSrc[0];

            //    if (firstRow.monthlyValues) {
            //        Object.keys(firstRow.monthlyValues).forEach(key => {
            //            col.push({
            //                dataField: key,
            //                caption: key,
            //                dataType: 'number',
            ...
            //                Object.keys(row.monthlyValues).forEach(key => {
            //                    row[key] = row.monthlyValues[key];
            //                });
            //            }
            //        });
            ...
            if (dataSrc && dataSrc.length > 0) {
                ...
                if (firstRow.monthlyValues) {
                    // 1. Pehle monthlyValues ki keys ko parse kar ke chronological (date wise) order mein sort karein
                    const sortedKeys = Object.keys(firstRow.monthlyValues).sort((a, b) => {
                        // "MMM-YY" ya "MMM-YYYY" format ko parse karne ke liye (e.g., "Jan-26" -> Date object)
                        // JavaScript Date constructor "Jan-26" ya "Jan-2026" ko parse kar leta hai
                    ...
                    // 3. Data flattening (baqi logic bilkul same rahega)
                    dataSrc.forEach(row => {
                        if (row.monthlyValues) {
                            Object.keys(row.monthlyValues).forEach(key => {
                                row[key] = row.monthlyValues[key];
        ...
        debugger;
        ////potrait
        if (reportId == 21 || reportId == 22 || reportId == 23 || reportId == 100 || reportId == 45 || reportId == 24 || reportId == 27 || reportId == 64 || reportId == 66 || reportId == 63 || reportId == 76 || reportId == 87
            ...
            || reportId == 118 || reportId == 132 || reportId == 133 || reportId == 134 || reportId == 135 || reportId == 67 || reportId == 140 || reportId == 141 || reportId == 144) {
        ...
        setTimeout(function () {
            ...
            if (reportId == 21 || reportId == 22 || reportId == 23 || reportId == 100 || reportId == 45 || reportId == 24 || reportId == 27 || reportId == 66 || reportId == 64 || reportId == 62 || reportId == 63 || reportId == 76 || reportId == 87 ||
                reportId == 65 || reportId == 18 || reportId == 19 || reportId == 20 || reportId == 46 || reportId == 47 || reportId == 48 || reportId == 88 || reportId == 89 || reportId == 90 || reportId == 91 || reportId == 94 || reportId == 117
                || reportId == 118 || reportId == 132 || reportId == 133 || reportId == 134 || reportId == 135 || reportId == 67 || reportId == 140 || reportId == 141 || reportId == 144) {
                empr_helper.DxGridBindingForReportsWithSetting_Aging('#ReportGridContainer', col, dataSrc, empr_helper.reportName);
            }
        ...
        setTimeout(function () {
            let gridInstance = $('#ReportGridContainer').dxDataGrid('instance');
            if (gridInstance) {
                let currentTotals = gridInstance.option("summary.totalItems") || [];
                let currentGroups = gridInstance.option("summary.groupItems") || [];
                    gridInstance.option("summary.totalItems", [...currentTotals, ...dynamicTotals]);
                gridInstance.option("summary.groupItems", [...currentGroups, ...dynamicGroups]);
            }
            var selectedRowKey = $('#GridContainer').dxDataGrid('instance').getSelectedRowKeys();
            if (selectedRowKey.length > 0) {
